                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-shopping-cart"></i>Productos</a>
                                <div id="submenu-2" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" type="button" data-toggle="modal" data-target="#add-product" style="cursor: pointer">Agregar Producto
                                                 <span class="badge badge-secondary" >Product</span></a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="/manage-products" style="cursor: pointer">Gestionar Productos</a>
                                        </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-controls="submenu-2" aria-expanded="false">
                                    <i class="fa fa-fw fa-user-circle"></i>Cambiar  Foto de perfil <span class="badge badge-success">6</span>
                                </a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Agregar Producot</h5>
                    ...
                    <div class="modal-body">
                        <form action="/add-product" class="form-group" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary btn-sm">Agregar</button>
                        </form>
                    </div>
